...
# code pour déterminer les libelles qui ont des valeurs NA dans nature
colonne1 <- c("libelle")
colonne2 <- c("indice")
...
# Pour déterminer le nombre de valeurs manquantes pour chaque libelle
...
filter(nature, nature$Nature == "Outil multifonction")
